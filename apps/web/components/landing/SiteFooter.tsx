        ...
        <div className="md:col-span-1">
          ...
          <div className="mt-5 flex items-center gap-3">
            {[
              {
                label: "Facebook",
                href: "https://facebook.com/camermove",
                icon: (
              ...
              {
                label: "Instagram",
                href: "https://instagram.com/camermove",
                icon: (
                  <svg className="size-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
              ...
              <a
                key={social.label}
                href={social.href}
                className="text-surface-2 transition-transform duration-200 hover:scale-110 hover:text-white"
              ...
              {g.links.map((l) => (
                <li key={l.label}>
                  {l.href.startsWith("http") || l.href.startsWith("mailto:") ? (
                    <a href={l.href} className="text-surface-2 transition-colors hover:text-white">
                      {l.label}
                    </a>
                  ) : (
                    <Link href={l.href} className="text-surface-2 transition-colors hover:text-white">
                      {l.label}
                    </Link>
                  )}
                </li>
