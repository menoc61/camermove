...
export function SearchBar() {
  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-3 rounded-2xl bg-white p-5 shadow-sm">
      ...
      <button type="submit" className="rounded-lg bg-primary px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-dark">{t("search.trip")}</button>
    </form>
  )
}
